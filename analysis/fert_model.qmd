...
fertility_data %>%
  ...
  kable(caption = "Prepared fertility data by cohort year.")

head(fertility_data, n = 15) %>%
  kable(caption = "Expanded fertility counts reconstructed from aggregate processed data for the 1950, 1960, 1970, 1980, and 1990 cohorts.")
```
